        ...
        for slab in slabs:
            ...
            if isinstance(translation_for_wall, np.ndarray):
                ...
                for connected_wall in connected_walls:
                    nodes_of_connected_wall = bim2fem.ifcplus.util.structural.get_ordered_structural_point_connections_of_triangular_structural_surface_member(
...
def get_walls_connected_to_wall(
    ...
    nodes_of_given_wall = bim2fem.ifcplus.util.structural.get_ordered_structural_point_connections_of_triangular_structural_surface_member(
        triangular_structural_surface_member=wall
    )
