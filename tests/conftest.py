...
OUTPUT_DIR_FOR_HVAC = OUTPUT_DIR_FOR_IFCPLUS / "hvac"
OUTPUT_DIR_FOR_HVAC.mkdir(exist_ok=True)

OUTPUT_DIR_FOR_PIPING = OUTPUT_DIR_FOR_IFCPLUS / "piping"
OUTPUT_DIR_FOR_PIPING.mkdir(exist_ok=True)
