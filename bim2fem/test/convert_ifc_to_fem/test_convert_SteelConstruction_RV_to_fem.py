...
def main() -> int:
    ...
    ifc4_sav_file = bim2fem.convert_ifc_to_fem.convert_ifc_to_fem(
        ...
        # element_selection_query="1v96O$YqXCRB7ePWhgPf95",  # irregular beam
        # element_selection_query="1v96O$YqXCRB7ePWhgPf95",  # top slab
        element_deselection_query='type = "M_Footing-Rectangular:1800 x 1200 x 450mm"',
        region="Europe",
    )
